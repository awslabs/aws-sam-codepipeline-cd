...
1. Create an AWS Secret using the newly created GitHub OAuth token, the value should be stored as plain text, no quotes or JSON wrapper is required. This should be named `GitHubOAuthToken` if you plan to use the default.
